...
exports.verifyEmailUser = function (userName, email, link, lang) {
    ...
    mailer(email, util.format(language.getLanguage('vui_long_xac_thuc_email_cua_ban', lang), [userName]), emailContent)
};
...
exports.resetPassAccount = function (email, userName, link, type) {
    ...
    mailer(email, `${webName}: Reset password`, emailContent);
};
...
exports.sendMailDynamic = ({ from, to, subject, content, attachments }) => {
